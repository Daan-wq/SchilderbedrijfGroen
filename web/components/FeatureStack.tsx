        ...
        <section className={clsx("w-full py-24", {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-12 lg:gap-24 items-start">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    {/* Card 1: Schilderwerk */}
                    <div className="bg-primary-900 text-white p-8 rounded-2xl shadow-xl transform transition-transform hover:-translate-y-1">
                    ...
                    {/* Card 2: Behangen */}
                    <div className="bg-white text-primary-950 p-8 rounded-2xl shadow-md border border-primary-100 transform transition-transform hover:-translate-y-1">
                    ...
                    {/* Card 3: Glas */}
                    <div className="bg-primary-800 text-white p-8 rounded-2xl shadow-xl transform transition-transform hover:-translate-y-1">
