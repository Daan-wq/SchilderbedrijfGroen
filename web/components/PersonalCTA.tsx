        ...
        <section className="w-full bg-primary-50 py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="md:pr-12">
                    <h2 className="text-3xl font-bold text-primary-950 mb-6">Zullen we kennismaken?</h2>
                ...
                <div className="relative aspect-[3/4] md:aspect-square rounded-full md:rounded-3xl overflow-hidden border-8 border-white shadow-xl max-w-sm mx-auto md:max-w-none">
                    <Image
