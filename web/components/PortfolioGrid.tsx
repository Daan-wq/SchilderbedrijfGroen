        ...
        <section className={clsx("w-full py-24", {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                    <div>
                        <span className="block text-primary-600 font-bold uppercase tracking-wide text-sm mb-2">Impressies</span>
                        <h2 className="text-3xl md:text-4xl font-bold text-primary-950">Recent opgeleverd werk</h2>
                    </div>
                    ...
                    {visibleProjects.map((item) => (
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-6">
                                <span className="inline-block px-3 py-1 rounded-full border border-white/30 text-xs font-medium text-white backdrop-blur-sm mb-2 w-fit">
                                    {item.category}
                                </span>
                                <h3 className="text-xl font-bold text-white group-hover:text-primary-50 transition-colors">{item.title}</h3>
                            </div>
                        </Link>
                    ))}
                </div>
